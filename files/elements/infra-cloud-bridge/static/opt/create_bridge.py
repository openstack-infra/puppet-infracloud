...
iface {bridge_name} inet static
    ...
    post-up ip route add default via {gateway} dev {bridge_name}
...
"""
    ...
    # start the bridge because at this point, interfaces are already
    # up so we need to do it manually. This will only happen first
    # time that the bridge is configured, because on reboots, we won't
    # reach this configure_bridge method
